...
public class Interfaz{
	...
	public void gestionarZonaMasCandidatosUmbral(){
		ZonaReclutamiento reporte = miSeleccionDePersonal.encontrarZonaConMasCandidatosSuperanUmbral();
		System.out.println("El pais con mas candidatos que superan el umbral es: " + reporte.darPais()+ " con una cantidad de candidatos de: "+ reporte.contarCandidatosSuperanUmbral());
	}
	...
	public void gestionarFiltradoEspecial(){
		miSeleccionDePersonal.hacerFiltradoEspecial();
		
		MostrarTablaColaboradores();
	}

	public void gestionarTotalCandidatos() {
		int totalC = miSeleccionDePersonal.contarCandidatos();
